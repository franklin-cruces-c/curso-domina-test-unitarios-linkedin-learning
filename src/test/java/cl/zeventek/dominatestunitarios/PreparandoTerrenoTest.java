...
class PreparandoTerrenoTest {
	...
	@BeforeAll
	static void antesDeNada() throws IOException {
		listaBase = new ArrayList<>();
		String currentPath = System.getProperty("user.dir");
		System.out.println("Path actual: " + currentPath);
		s = new Scanner(new File(currentPath+"/src/main/resources/entrada.txt"));
